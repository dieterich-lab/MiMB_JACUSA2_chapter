...
NMFtabSlim=NMFtab[,16:30] # just WT vs KO
...
dev.off()
#
res <- nmf(NMFtabSlim, 6, nrun=10, seed=123456, .opt='vp3')
...
split.screen(c(1, 2))
screen(1)
rep1=matrix(h[4,],ncol=5,byrow=T)[1:3,]
...
screen(2)
rep2=matrix(h[4,],ncol=5,byrow=T)[4:6,]
