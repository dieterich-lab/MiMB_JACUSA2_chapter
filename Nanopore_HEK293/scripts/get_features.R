...
# BigTable=readRDS("../../MiMB_JACUSA2_chapter-copie/Nanopore_HEK293/Res_WT_RealIVT/BigTable.rds")
# BigTabl = BigTable[!(rownames(BigTable) %in% rownames(BigTable2)),]

# BigTable = BigTable[(rownames(BigTable) %in% rownames(BigTable2)),]
